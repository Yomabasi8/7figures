      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {placeholders.map((p, i) => (
            <div
              key={i}
              className="reveal bg-red-50 border border-red-100 rounded-2xl p-6 flex flex-col gap-4"
            >
              {/* Stars */}
              ...
              {/* Media placeholder */}
              <div className="flex-1 min-h-[120px] bg-red-100 rounded-xl flex flex-col items-center justify-center gap-2 border-2 border-dashed border-red-200 text-red-400">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-neutral-900 text-sm">{p.initials}</p>
                  <p className="text-neutral-400 text-xs">{p.label}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <p className="text-center text-neutral-400 text-sm mt-6 reveal">
